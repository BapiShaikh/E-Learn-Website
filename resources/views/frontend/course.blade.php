...
<body>
    ...
    <div class="container">
      ...
      <div class="card  mt-4">
        <img src="{{url('frontend/images/best-laravel-based-cms-that-you-should-know-224x171.webp')}}" class="card-img-top" alt="..." height="200">
        <div class="card-body">
          <div class="text-section">
    ...
    <div class="card  mt-4">
        <img src="{{url('frontend/images/react_logo.png')}}" class="card-img-top" alt="..." height="200">
        <div class="card-body">
          <div class="text-section">
            <h5 class="card-title fw-bold text-white">React</h5>
            <p class="card-text">
                This React course covers the fundamentals of React.js, including components, state, props, and lifecycle methods. Participants will learn to build dynamic web applications, manage component states, and handle events.
                <details>
                    <summary class="summary">Read More..</summary>
    ...
    <div class="card  mt-4">
        <img src="{{url('frontend/images/angular.png')}}" class="card-img-top" alt="..." height="200">
        <div class="card-body">
          <div class="text-section">
    ...
    <div class="card  mt-4">
        <img src="{{url('frontend/images/dotnet.jpg')}}" class="card-img-top" alt="..." height="200">
        <div class="card-body">
          <div class="text-section">
